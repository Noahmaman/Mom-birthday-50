...
import {VOYAGE_DURATION, VoyageDeYael} from "./VoyageDeYael";
...
export const RemotionRoot: React.FC = () => (
  <>
    <Composition id="VoyageDeYael" component={VoyageDeYael} durationInFrames={VOYAGE_DURATION} fps={30} width={1920} height={1080} />
    <Folder name="Scenes">
