...
export const VOYAGE_DURATION = 20199;
...
export const VoyageDeYael: React.FC = () => (
  <TransitionSeries name="Voyage de Yael — montage final">
    ...
    <TransitionSeries.Sequence durationInFrames={965} name="Vidéo 2 — Olivier, fin à 1:07"><VideoMessage file={videoFiles.olivier} name="Olivier" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={1272} name="Vidéo 3 — David et Sandrine, fin à 1:49"><VideoMessage file={videoFiles.davidSandrine} name="David et Sandrine et David" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={1016} name="Vidéo 4 — Sandrinouche, Ti amo conservé"><VideoMessage file={videoFiles.sandrinouche} name="Sandrinouche" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-top-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={1317} name="Vidéo 5 — Gad, phrase restaurée"><VideoMessage file={videoFiles.gad} name="Gad" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={150} name="Transition 3 — Europe / Sirtaki"><TravelScene from="Asie" to="Europe" chapter="Chapitre 3" accent="#8fd0c9" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-top-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={DOMINIQUE_DURATION} name="Vidéo 8 — Photos Dominique"><DominiqueEdit /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(627)} name="Vidéo 10 — Sylvia et X"><VideoMessage file={videoFiles.sylvia} name="Sylvia et X" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={696} name="Photos — Vacances"><PhotoSlideshow photos={vacationPhotos} framesPerPhoto={24} title="Nos vacances" subtitle="29 souvenirs, mille histoires" musicFile="audio/music/me-gustas-tu.mp3" musicTrimBefore={90} musicVolume={0.36} /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={150} name="Transition 5 — Paris / Paris s’éveille"><TravelScene from="Sud de la France" to="Paris" chapter="Chapitre 5" accent="#e4b2bb" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-top-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(1913)} name="Vidéo 17 — Gilberte"><VideoMessage file={videoFiles.gilberte} name="Gilberte" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={408} name="Photos — Yael et Serge"><PhotoSlideshow photos={sergePhotos} framesPerPhoto={24} title="Yael et Serge" badgeText="Avec amour" imageObjectFit="cover" musicFile="audio/music/la-vie-en-rose.mp3" musicTrimBefore={0} musicVolume={0.34} /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={264} name="Photos — Climax"><PhotoSlideshow photos={climaxPhotos} framesPerPhoto={24} title="Ti amo" subtitle="De tous ceux qui t’aiment" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom"})} timing={linearTiming({durationInFrames: 12})} />
