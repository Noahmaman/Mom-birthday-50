...
import {DOMINIQUE_DURATION, DominiqueEdit} from "./scenes/DominiqueEdit";
...
export const VoyageDeYael: React.FC = () => (
  <TransitionSeries name="Voyage de Yael — montage final">
    ...
    <TransitionSeries.Sequence durationInFrames={atTempo(843)} name="Vidéo 1 — Nous"><VideoMessage file={videoFiles.nous} name="Nous" place="Le voyage commence" /></TransitionSeries.Sequence>
    ...
    <TransitionSeries.Sequence durationInFrames={atTempo(1110)} name="Vidéo 2 — Olivier"><VideoMessage file={videoFiles.olivier} name="Olivier" place="Ouest américain" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(2256)} name="Vidéo 3 — David et Sandrine"><VideoMessage file={videoFiles.davidSandrine} name="David et Sandrine" place="Californie" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(930)} name="Vidéo 4 — Sandrinouche"><VideoMessage file={videoFiles.sandrinouche} name="Sandrinouche" place="Brésil" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-top-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(1080)} name="Vidéo 5 — Gad"><VideoMessage file={videoFiles.gad} name="Gad" place="Thaïlande" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(378)} name="Vidéo 6 — Yaya"><VideoMessage file={videoFiles.yaya} name="Yaya" place="Tel Aviv" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-top-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(1226)} name="Vidéo 7 — Atlani"><VideoMessage file={videoFiles.atlani} name="Atlani" place="Europe" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={DOMINIQUE_DURATION} name="Vidéo 8 — Dominique (photos seules retirées)"><DominiqueEdit /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(2520)} name="Vidéo 9 — Laura"><VideoMessage file={videoFiles.laura} name="Laura" place="Irlande" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(627)} name="Vidéo 10 — Sylvia"><VideoMessage file={videoFiles.sylvia} name="Sylvia et son mari" place="Croatie" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={720} name="Photos — Vacances / tous"><PhotoSlideshow photos={vacationPhotos} framesPerPhoto={24} title="Nos voyages" subtitle="30 souvenirs, mille histoires" musicFile="audio/music/me-gustas-tu.mp3" musicTrimBefore={90} musicVolume={0.36} /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-top-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(1851)} name="Vidéo 12 — Serge Sud"><VideoMessage file={videoFiles.serge} name="Serge" place="Sud de la France" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(931)} name="Vidéo 14 — Rebecca"><VideoMessage file={videoFiles.rebecca} name="Rebecca" place="Biarritz" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-top-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(418)} name="Vidéo 15 — Marc"><VideoMessage file={videoFiles.marc} name="Marc" place="Paris" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(468)} name="Vidéo 16 — Monelle"><VideoMessage file={videoFiles.monelle} name="Monelle" place="Paris" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(1913)} name="Vidéo 17 — Gilberte"><VideoMessage file={videoFiles.gilberte} name="Gilberte" place="Paris" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={432} name="Photos — Serge et Yael"><PhotoSlideshow photos={sergePhotos} framesPerPhoto={24} title="Serge & Yael" subtitle="La vie en rose" musicFile="audio/music/la-vie-en-rose.mp3" musicTrimBefore={0} musicVolume={0.34} /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-top"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(60)} name="Vidéo 19 — Sydney (19s à 21s)"><VideoMessage file={videoFiles.sydney} name="Sydney" trimBefore={570} /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    ...
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(750)} name="Ajout — Johanna, Ralph et Elisabeth"><VideoMessage file={videoFiles.johanna} name="Johanna, Ralph et Elisabeth" place="Un nouveau message d’amour" /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-right"})} timing={linearTiming({durationInFrames: 12})} />
    <TransitionSeries.Sequence durationInFrames={atTempo(120)} name="Gad — reprise (38s à 42s)"><VideoMessage file={videoFiles.gad} name="Gad" trimBefore={1140} /></TransitionSeries.Sequence>
    <TransitionSeries.Transition presentation={wipe({direction: "from-bottom-left"})} timing={linearTiming({durationInFrames: 12})} />
